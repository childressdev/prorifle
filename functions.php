...
add_action('wp_enqueue_scripts', 'prorifle_scripts', 100);
function prorifle_scripts(){
  wp_register_script(
    'bootstrap-script', 
  ...
  wp_register_script(
    'prorifle-scripts', 
    get_template_directory_uri() . '/js/prorifle-scripts.js', 
    array('jquery'), 
    '', 
    true
  );
  ...
  wp_enqueue_script('prorifle-scripts');  
}

add_action('wp_enqueue_scripts', 'prorifle_styles');
function prorifle_styles(){
  wp_register_style('bootstrap-css', '//maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css');
  wp_register_style('prorifle', get_template_directory_uri() . '/style.css');
